...
namespace ContactsManager.ControllerTests
{
    public class PersonsControllerTest
    {
        ...
        {
            //Arrange
            List<PersonResponseDto> personResponseDtos = new()
            {
            ...
            PersonController personController = new(_countriesService, _logger,_personsAdderService, _personsGetterService,_personsSorterService);
        ...
        public async Task Create_WithValidDetails()
        {
            ...
            List<CountryResponseDto> countries = new()
            {
            ...
            PersonAddRequestDto personRequestDtos = new()
            {
                PersonName = "Kokash",
                Email = "kokash@mail.com",
                Address = "kokash Address",
