...
namespace ContactsManager.ServiceTests
{
    ...
    public class CountriesServiceTest
    {
        ...
        {
            // Arrange
            CountryAddRequestDto? countryAddRequestDto = new()
            {
                CountryName = null
            };
        ...
        public async Task  AddCountry_DuplicateCountryName()
        {
            ...
            CountryAddRequestDto? countryAddRequestDto1 = new()
            {
                CountryName = "USA"
            };
        ...
        public async Task  AddCountry_SucessfulCountryInsertion()
        {
            ...
            // Arrange
            CountryAddRequestDto? expectedCountry = new()
            {
                CountryName = "Japan"
            };
            Country country = new()
        ...
        {
            //Arrange
            List<CountryAddRequestDto> countryAddRequest = new() {
            ...
            List<CountryResponseDto> expectedCountryResponse = new();
            _mockMapper.Setup(m => m.Map<List<CountryResponseDto>>(It.IsAny<List<Country>>()))
                .Returns((List<Country> countries) =>
        ...
        public async Task  GetCountryById_ValidCountryId()
        {
            ...
            CountryAddRequestDto countryAddRequest = new()
            {
                CountryName = "India",
            };
            Country country = new()
            ...
            CountryResponseDto expectedcountryResponse = new()
            {
                CountryId = countryId,
                CountryName = "Japan"
            };
